...
public class WxUnifiedOrder {
     ...
     * 获取微信支付签名
     */
    @RequestMapping(value = "/wap_pay_signature", method = RequestMethod.GET)
    @ResponseBody
...
//        Map<String, String> data = getAccess_tokenByCode(code, response);
        ...
        String tName =  request.getParameter("tName");//商品名称
     ...
     */
    Map<String, String> getAccess_tokenByCode(String code,HttpServletResponse response) {
        ...
        String access_token = (String) json.get("session_key");
